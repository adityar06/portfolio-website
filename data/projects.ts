...
export const projects: Project[] = [
  ...
  },
  {
    ...
    videoSrc: '/Contract Intelligence.mp4',
    techStack: ['Claude API', 'Python', 'n8n'],
  ...
  {
    slug: 'ai-warehouse-slotting-optimizer',
    title: 'AI Warehouse Slotting Optimizer',
    tagline: 'An AI powered slotting tool that turns 90 days of order history into a complete SKU placement analysis — quantifying pick-time savings, detecting co-purchase clusters, and delivering a prioritised relocation plan from a single CSV upload.',
    description: 'An AI powered slotting tool that turns 90 days of order history into a complete SKU placement analysis — quantifying pick-time savings, detecting co-purchase clusters, and delivering a prioritised relocation plan from a single CSV upload.',
    category: 'ai-automation',
    thumbnail: '/AI Warehouse Slotting Optimizer.jpg',
    videoSrc: '/AI Warehouse Slotting Optimizer.mp4',
    techStack: ['Claude API', 'Python', 'Streamlit'],
    overview: `Poor SKU placement quietly drains pick-time efficiency in most warehouses — high-velocity items buried in deep storage, co-purchased products scattered across zones, and prime golden-zone slots occupied by slow movers. Most slotting decisions are made on instinct or legacy habit, with no structured analysis of actual order data or co-purchase behaviour.\n\nFixing it the conventional way requires a logistics engineer, days of data work, and a manual relocation plan — resources most operations teams don't have.`,
    howBuilt: `SlotIQ turns 90 days of order history into a complete slotting analysis from a single CSV upload. Claude AI segments every SKU by velocity and demand variability using an AZ-analysis framework, detects co-purchase affinity clusters from order co-occurrence patterns, and assigns each SKU to its optimal zone — A (golden), B (mid), or C (bulk reserve).\n\nThe output spans five views: a visual warehouse layout, a sortable re-slotting table, a ranked priority moves list with per-move time savings, a co-purchase cluster map, and an AI-generated Efficiency Brief in plain English — ready to forward to an ops director without further editing.`,
    keyFeatures: [
      'Quantifies potential pick-time reduction upfront, making the business case for slotting investment immediately visible',
      'Ranks every misplaced SKU with AI-generated reasoning grounded in pick frequency, demand variability, and co-purchase data',
      'Surfaces co-purchase affinity clusters so adjacent-bay co-location eliminates cross-zone travel on multi-line picks',
      'Delivers a top-10 priority move list targeting ~80% of total efficiency gain — giving ops teams a clear starting point, not an overwhelming backlog',
    ],
    sectionTitles: {
      overview: 'The Problem',
      howBuilt: 'How This Tool Solves It',
